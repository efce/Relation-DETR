...
# from configs.train_config import model_path
...
weight = load_checkpoint(
    '/home/fc/HDD_DATA/git/FOCAL/Relation-DETR/weights/downloaded/relation_detr_swin_l_800_1333_coco_2x.pth'
)
load_state_dict(model, weight)
model_path = '/home/fc/HDD_DATA/git/FOCAL/Relation-DETR/weights/downloaded/relation_detr_swin_l_800_1333_coco_2x.pth'
